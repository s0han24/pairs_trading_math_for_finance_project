...
def filter_pairs_by_correlation(price_df, threshold=0.8, n=10, corr_method='pearson'):
    corr_func = corr_functions.get(corr_method, pearson_correlation)
    corr = corr_func(price_df.T.to_numpy())
    pairs = []
